...
declare type DeepPartial<T> = T extends Primitive ? T : T extends Function ? T : T extends Date ? T : T extends Map<infer K, infer V> ? DeepPartialMap<K, V> : T extends Set<infer U> ? DeepPartialSet<U> : T extends {} ? {
...
export declare abstract class Handler<SpecificMessage> {
    abstract handle(socketWrapper: SocketWrapper | null, message: SpecificMessage, originServerName: string): void;
...
export declare type DeepstreamHTTPResponse = (error: {
    statusCode: number;
    message: string;
} | null, data?: any) => void;
export declare type PostRequestHandler<DataInterface> = (data: DataInterface, meta: DeepstreamHTTPMeta, onResponse: DeepstreamHTTPResponse) => void;
export declare type GetRequestHandler = (meta: DeepstreamHTTPMeta, onResponse: DeepstreamHTTPResponse) => void;
...
export declare type SocketWrapperFactory = Function;
...
export declare type LoggerPlugin<PluginOptions = any> = new (pluginConfig: PluginOptions, services: DeepstreamServices, config: DeepstreamConfig) => DeepstreamLogger;
...
export declare type ConnectionEndpointPlugin<PluginOptions = any> = new (pluginConfig: PluginOptions, services: DeepstreamServices, config: DeepstreamConfig) => DeepstreamConnectionEndpoint;
export interface SocketConnectionEndpoint extends DeepstreamConnectionEndpoint {
    scheduleFlush(socketWrapper: SocketWrapper): void;
}
export declare type SocketConnectionEndpointPlugin<PluginOptions = any> = new (pluginConfig: PluginOptions, services: DeepstreamServices, config: DeepstreamConfig) => SocketConnectionEndpoint;
export declare type StateRegistryCallback = (name: string) => void;
...
export declare abstract class DeepstreamPlugin {
...
export declare type StorageHeadBulkCallback = (error: string | null, versions?: {
    [index: string]: number;
}, missing?: string[]) => void;
export declare type StorageHeadCallback = (error: string | null, version?: number) => void;
export declare type StorageReadCallback = (error: string | null, version?: number, result?: any) => void;
export declare type StorageWriteCallback = (error: string | null) => void;
...
export declare type MonitoringPlugin<PluginOptions = any> = new (pluginConfig: PluginOptions, services: DeepstreamServices, config: DeepstreamConfig) => DeepstreamMonitoring;
export interface DeepstreamTelemetry extends DeepstreamPlugin {
}
export declare type TelemetryPlugin<PluginOptions = any> = new (pluginConfig: PluginOptions, services: DeepstreamServices, config: DeepstreamConfig) => DeepstreamTelemetry;
export declare type PermissionCallback = (socketWrapper: SocketWrapper, message: Message, passItOn: any, error: Error | string | ALL_ACTIONS | null, result: boolean) => void;
...
export declare type UserAuthenticationCallback = (isValid: boolean, userAuthData?: DeepstreamAuthenticationResult) => void;
...
export declare type ClusterNodePlugin<PluginOptions = any> = new (pluginConfig: PluginOptions, services: DeepstreamServices, config: DeepstreamConfig) => DeepstreamClusterNode;
export declare type LockCallback = (locked: boolean) => void;
...
export declare type LockRegistryPlugin<PluginOptions = any> = new (pluginConfig: PluginOptions, services: DeepstreamServices, config: DeepstreamConfig) => DeepstreamLockRegistry;
...
export declare type ClusterRegistryPlugin<PluginOptions = any> = new (pluginConfig: PluginOptions, services: DeepstreamServices, config: DeepstreamConfig) => ClusterRegistry;
export declare type PartialDeepstreamConfig = DeepPartial<DeepstreamConfig>;
...
export declare type ValveSchema = {
    [index: string]: ConfigSchema;
};
